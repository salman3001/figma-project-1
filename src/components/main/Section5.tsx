export const Section5 = () => {
  return (
    <div className=" flex flex-col gap-4 p-20 pb-10  w-full text-white">
      <div className="bg-[#03444F] flex flex-col gap-2 rounded-2xl p-20">
        <div className=" text-4xl font-bold">Ease to Made Laundry</div>
        <div>
          <div className="w-1/2 text-[#EBEBEB] opacity-90">
